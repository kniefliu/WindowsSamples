...
class MulTabFrameWnd : public CWindowWnd, public INotifyUI
{
public:
	MulTabFrameWnd() { };
	...
	void Notify(TNotifyUI& msg)
	{
		...
		if (msg.sType==_T("click"))
		{
			if (name==_T("NewItemBtn"))
			{
				...
				pNewOption->SetAttributeList(_T(" float=\"false\" ")\
				...
				pCloseBtn->SetAttributeList(_T("name=\"CloseTabBtn\" float=\"true\" normalimage=\"tab_close_Crop1.png\" hotimage=\"tab_close_Crop1.png\" pushedimage=\"tab_close_Crop3.png\" bordersize=\"0\" pos=\"-24,12,-12,24\" bordercolor=\"#FF000000\" width=\"12\" height=\"12\""));

				//标签HorLayout  ==  OptionUI + 关闭按钮
				CHorizontalLayoutUI* pNewHorLayout=new CHorizontalLayoutUI;
				pNewHorLayout->SetAttributeList(_T("maxwidth=\"174\" "));
...
#endif
	CPaintManagerUI::SetResourcePath(strDuiResPath + _T("skin/MulTab"));

	HRESULT Hr = ::CoInitialize(NULL);
	if( FAILED(Hr) ) return 0;

	MulTabFrameWnd* pFrame = new MulTabFrameWnd();
