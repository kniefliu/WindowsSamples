...
set(QUI_INCLUDE_PATH "${_QUI_ROOT}/qui/include")

# Path to the qui target.
set(QUI_LIBQUI_DLL_WRAPPER_PATH "${_QUI_ROOT}/qui")
...
if(OS_WINDOWS)
  ...
  # QUI library paths.
  set(QUI_LIB_DEBUG   "${QUI_BINARY_DIR_DEBUG}/qui.lib")
  set(QUI_LIB_RELEASE "${QUI_BINARY_DIR_RELEASE}/qui.lib")
  ...
  # List of QUI resource files.
  set(QUI_RESOURCE_FILES
    qui.pak    
    )
